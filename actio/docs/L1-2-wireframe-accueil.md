...
| D5 | `--encre-hausse`, `--encre-baisse`, `--encre-stable` orphelins depuis le passage à `--encre-*`, avec un appel résiduel en style en ligne (l. 64) | Supprimer la section 10 de `tokens.css` et corriger la l. 64, ou rétablir l'usage |
