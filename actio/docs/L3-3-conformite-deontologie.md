...
### 3.1 Politique sur les partenariats rémunérés et l'affiliation
...
|---|---|---|---|
| Initial, avant signature | Réviseur juridique | Listes ACVM (autorisées **et** proscrites) + registre de chaque province ciblée | Une fois, capture horodatée au dossier |
| Contre-contrôle | Rédactrice en chef adjointe | Mêmes registres, consultation indépendante | Une fois, avant signature |
| Périodique | Réviseur juridique | Mêmes registres | **Tous les 30 jours** tant que la campagne est servie |
...
>
> **[ ].7** L'Annonceur garantit l'Éditeur contre toute réclamation, sanction ou condamnation résultant de l'inexactitude des déclarations de l'article [ ].1 ou du contenu des Créations qu'il a fournies.
>
> **[ ].8** L'Éditeur publie l'identité de l'Annonceur et la nature de la contrepartie sur sa page publique des partenariats, ce que l'Annonceur accepte expressément.

---

### 3.2 Indépendance de la rédaction et mur de séparation

#### 3.2.1 Qui relève de qui, qui ne parle pas à qui

| Fonction | Relève de | Parle à un annonceur | Connaît le calendrier commercial |
|---|---|---|---|
| Rédactrice en chef | Direction générale, **jamais** de la direction des revenus | Oui, en présence d'un tiers, jamais sur un sujet en cours | Oui — arbitrage d'adjacence |
| Rédactrice en chef adjointe, chef de pupitre | Rédactrice en chef | Non | Non |
| Journalistes et pigistes | Chef de pupitre | **Non**, sauf comme source citée et identifiée | Non |
...
| # | Étape | Qui | Délai | Point de contrôle bloquant |
|---|---|---|---|---|
| 1 | Qualification de l'annonceur | Réviseur juridique | J‑15 | Inscription vérifiée aux deux listes ACVM + registre provincial, capture horodatée |
| 2 | Signature avec la clause du § 3.1.5 | Directeur des revenus | J‑12 | Refus si un alinéa est amendé |
| 3 | Brief et rédaction | Studio | J‑10 à J‑5 | Aucun contact avec la rédaction |
| 4 | Conformité du contenu | Réviseur juridique | J‑4 | Aucune recommandation, aucun rendement prospectif, aucun code de parrainage |
...
Deux règles écrites pour être citées le jour venu : **un annonceur sanctionné n'obtient jamais l'antériorité de l'information** — il apprend la publication en la lisant ; **avoir été annonceur n'est ni un motif de couverture renforcée, ni un motif de retenue** — c'est un fait divulgué, ce qui est autre chose.
...
| Objet | Règle |
|---|---|
| Bitcoin et ether détenus avant l'embauche | Autorisés, déclarés, **gelés** : aucune transaction hors sortie totale annoncée 30 jours à l'avance |
| Autres cryptoactifs, jetons non fongibles, jetons de gouvernance | **Interdits** à toute personne de la chaîne éditoriale |
| Titres d'une plateforme, d'un émetteur, d'un dépositaire ou d'un fournisseur cité | **Interdits** |
| Fonds négociés en bourse de cryptoactifs, fonds diversifiés sans exposition dirigée | Autorisés, déclarés |
...
### 3.3 Disclaimers types

Le français fait foi ; l'anglais est une traduction de service, non publiable sans révision par un juriste de common law [À VÉRIFIER].

#### 3.3.1 Avertissement général du pied de page
...
> **Scope of this analysis.** This article describes the law as it stood on [date], for the following jurisdictions: [jurisdictions]. It is not legal advice, investment advice or a recommendation. Regulatory staff notices are not rules: they set out a regulator's interpretation and have no binding force of their own. A statute that has been enacted or received Royal Assent is not necessarily in force; commencement may depend on an order in council and on regulations not yet made. Verify the status of a provision against the primary source before relying on it.
...
> **Tax notice.** Actio is not a chartered professional accountant, a tax adviser or a legal adviser, and this article is not tax advice. The tax characterization of a crypto asset transaction depends on each taxpayer's own facts, including frequency of transactions, intention, holding period and method of financing. Administrative positions of the Canada Revenue Agency and Revenu Québec are not legislation and may change without notice. Several treatments — staking, airdrops, decentralized finance — are not the subject of any published formal guidance: the prevailing practice of law and accounting firms must not be attributed to the tax authorities. Consult a professional before filing.

#### 3.3.4 Contenu commandité

*Risque couvert :* défaut de divulgation d'un lien matériel au sens de la *Loi sur la concurrence* ; requalification du contenu en matériel de marketing diffusé pour le compte d'une plateforme.

> **Contenu commandité.** Ce contenu a été payé par [entité juridique], inscrite auprès de [autorité] sous le numéro [numéro]. Il a été rédigé par ou pour cet annonceur et **n'a pas été rédigé par la rédaction d'Actio**, qui n'en a contrôlé ni les faits, ni les analyses. Il ne constitue ni un avis juridique, ni un conseil en placement, ni une recommandation d'Actio. La rédaction est indépendante des activités commerciales du média : voir la charte d'indépendance.

> **Sponsored content.** This content was paid for by [legal entity], registered with [regulator] under number [number]. It was written by or for that advertiser and **was not written by Actio's newsroom**, which verified neither its facts nor its analysis. It is not legal advice, investment advice or a recommendation by Actio. The newsroom is independent of the publication's commercial operations: see our independence policy.
...
> **Data source and cut-off.** This chart is based on [source] and is current as at [date, time]. It reflects Actio's reading and is not an official publication. Registration statuses change continuously: only the registers of the competent regulators are authoritative as at the date you consult them. Data not verified against a primary source is flagged as such. No data point is keyed in by hand.

Emplacements : `.schema__pied` pour un schéma, `<caption>` pour un `.tableau`, `.provenance__horodatage` pour le registre.
...
> **Limitation of liability.** Actio's content is provided for general information, on an "as is" basis, without warranty of accuracy, completeness or currency. Actio Média inc., its officers, employees and contributors disclaim all liability for decisions taken in reliance on this content and for any resulting damages, direct or indirect, to the extent permitted by applicable law. Links to third-party sites are neither an endorsement nor a verification. **Law stated as at [date].** Developments after that date are not reflected.

---

### 3.4 Conformité opérationnelle du média lui-même
...
|---|---|---|
| Consentement exprès non précoché | `input[name="consentement"]` dans `.infolettre__consentement`, puis double consentement | Fiche : horodatage du **clic de confirmation**, IP, page d'origine, libellé intégral affiché |
| Identification de l'expéditeur ; adresse postale valide **60 jours** après l'envoi | Dénomination et adresse en dur dans le gabarit, jamais en variable | Gabarit versionné ; bail |
| Exclusion valide **60 jours**, traitée sous **10 jours ouvrables** | Retrait immédiat en pratique ; la fiche de consentement est **conservée** après désabonnement, comme preuve | Journal des retraits |
...
| Obligation | Exécution | Échéance |
|---|---|---|
| Politique de confidentialité publiée en langage clair | Lien déjà posé dans `.pied__legal` et dans le pied de l'infolettre | Avant le premier envoi |
| **Responsable de la protection des renseignements personnels désigné et publié** (nom, fonction, coordonnées) | À nommer ; à défaut, la personne ayant la plus haute autorité | Avant le premier envoi |
| Registre **de tous** les incidents de confidentialité, sans seuil | `docs/annexes/registre-incidents.csv` | Permanent |
| Signalement à la CAI et aux personnes concernées **avec diligence** en cas de risque de préjudice sérieux | Escalade en 4 h | Au cas par cas |
| Déclaration fédérale et registre conservé **24 mois** en cas d'atteinte présentant un **risque réel de préjudice grave** | Même procédure, double qualification | Permanent |
...
| Instrument | Applicabilité à Actio | Position |
|---|---|---|
| *Loi canadienne sur l'accessibilité* | Entités sous réglementation fédérale seulement ; un média numérique indépendant n'y est **vraisemblablement pas** assujetti | Ne pas invoquer d'obligation |
| CAN/ASC-EN 301 549:2024 (intègre WCAG 2.1 AA) | Norme **volontaire** | Référence technique retenue |
...
| Nom d'une autorité en texte, dans une couleur de juridiction (`--jur-federal`, `--jur-quebec`, `--jur-ontario`, `--jur-multi`) | **Permis** ; toute mise en forme évoquant une identité visuelle officielle est interdite |
| Polices du site (Source Serif 4, Inter, IBM Plex Mono) | Auto-hébergement **permis** sous SIL OFL 1.1, fichiers de licence redistribués ; millésimes à vérifier (`U-77`) |

---

### 3.5 Politique de correction et gestion des erreurs
...
|---|---|---|---|---|
| **1 — Coquille** | Orthographe, ponctuation, lien mort, sans effet sur le sens | 4 h ouvrées | Aucun | Aucun |
| **2 — Imprécision** | Fait exact, formulation susceptible d'induire en erreur, juridiction non précisée | 24 h | `.maj` étiquette « Mise à jour » ; 2ᵉ ligne dans `.article__dates` | Journal des corrections |
...
| Voie | Point d'entrée | Accusé de réception | Qualification |
|---|---|---|---|
| Lecteur | Lien « Nous signaler une erreur » de `.pied__legal` | **2 jours ouvrables** | 5 jours ouvrables |
| Auteur ou source citée | Même formulaire, qualité mentionnée | 1 jour ouvrable | 3 jours ouvrables |
...
| T+ | Acte | Responsable |
|---|---|---|
| 0 | Accusé de réception écrit, sans reconnaissance ni contestation ; aucune modification, aucune dépublication, aucun échange sur le fond | Rédactrice en chef |
| 0 | **Gel de l'article** : ni retrait, ni retouche, ni suppression des versions antérieures ; capture horodatée de l'état publié | Intégrateur |
| 0 | Notification à l'avocat d'Actio et à l'assureur en responsabilité civile professionnelle et médias — **police à souscrire avant la mise en ligne**, sans quoi ce point est inexécutable | Direction générale |
| 24 h | Vérification factuelle menée par une personne n'ayant pas participé à l'article | Réviseur juridique |
...
2. **La classe `.commandite`.** Absente d'`actio.css`. Composant dédié sur les jetons de consultation, ou réemploi de `.avertissement` en rouge d'alerte, au risque de traiter une divulgation comme un danger.
