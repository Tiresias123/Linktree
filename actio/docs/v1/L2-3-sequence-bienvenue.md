...
> **Avertissement opposable sur le chapitre 7.** Chaque seuil, chaque montant de pénalité, chaque numéro d'article et chaque référence de décision de ce chapitre provient d'un résultat de recherche indexé, jamais du texte officiel. Le registre de vérification juge le prototype conforme **précisément parce qu'il ne cite ni le seuil de 100 000 $ (V-29) ni aucun numéro d'article (V-30)**, et le risque R5 du livrable 3, § 4.4, interdit « aucun montant, aucun numéro d'article publié depuis une source secondaire ». Le sommaire ci-dessus décrit donc ce que le chapitre **devra établir**, non ce qu'il peut affirmer aujourd'hui. **Aucune de ces valeurs ne part en boîte de réception avant relecture fiscale sur source primaire**, et le courriel C1 ne remet pas le guide tant que cette relecture n'est pas faite — c'est la condition de sortie nº 1 du § « Ce qui reste à trancher ».
